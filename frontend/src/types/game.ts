...
export const CATEGORIES_CONFIG: Record<CategoryType, CategoryInfo> = {
  association: {
    ...
    colorHex: '#EF4444',
    name: 'Asociación',
    description: 'Uní las 4 parejas de conceptos de ambas columnas',
    iconName: 'Link2',
  },
  sequence: {
    type: 'sequence',
  ...
  approximation: {
    ...
    colorHex: '#F59E0B',
    name: 'Aproximación',
    description: 'Calculá o estimá la cifra más cercana',
    iconName: 'Calculator',
  },
  common: {
    type: 'common',
    ...
    colorHex: '#10B981',
    name: 'En Común',
    description: 'Descubrí qué une a estos 4 elementos',
    iconName: 'Layers',
  },
};
